...
# Remove Hadoop/Spark env variables from ~/.zshrc
echo "Removing Environment variables"
sed -i '/export HADOOP_HOME/d' ~/.zshrc
sed -i '/export HADOOP_CONF_DIR/d' ~/.zshrc
sed -i '/export SPARK_HOME/d' ~/.zshrc
sed -i '/HADOOP_HOME\/bin/d' ~/.zshrc
sed -i '/HADOOP_HOME\/sbin/d' ~/.zshrc
sed -i '/SPARK_HOME\/bin/d' ~/.zshrc
sed -i '/SPARK_HOME\/sbin/d' ~/.zshrc
...
# echo 'export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin' >> ~/.zshrc
